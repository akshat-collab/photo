...
export default function PhotoBoothApp() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary via-accent to-secondary relative overflow-hidden flex flex-col">
      <div className="absolute inset-0 opacity-40">
        {backgroundClouds.map((cloud, index) => (
          <div
            key={index}
      ...
      <footer className="bg-primary-foreground text-primary p-4 text-center mt-auto">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
          <div>© {new Date().getFullYear()} DeoBooth</div>
          <div>
            <span className="font-semibold">Team Support:</span> Akshat Singh
          </div>
          <div>
            <a
              href="mailto:support@deobooth.com"
